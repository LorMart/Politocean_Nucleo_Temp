...
#define MBED_CONF_MBED_MQTT_MAX_CONNECTIONS                                   5                                                                                                // set by library:mbed-mqtt
#define MBED_CONF_MBED_MQTT_MAX_PACKET_SIZE                                   200                                                                                              // set by library:mbed-mqtt
...
#define MBED_CONF_WIZNET_CS                                                   SPI_CS                                                                                           // set by library:WIZNET
#define MBED_CONF_WIZNET_DEBUG                                                1                                                                                                // set by library:WIZNET
#define MBED_CONF_WIZNET_DEFAULT_NETWORK                                      0                                                                                                // set by library:WIZNET
#define MBED_CONF_WIZNET_INTERFACE                                            W5500                                                                                            // set by library:WIZNET
#define MBED_CONF_WIZNET_MISO                                                 SPI_MISO                                                                                         // set by library:WIZNET
#define MBED_CONF_WIZNET_MOSI                                                 SPI_MOSI                                                                                         // set by library:WIZNET
#define MBED_CONF_WIZNET_RST                                                  SPI_RESET                                                                                        // set by library:WIZNET
#define MBED_CONF_WIZNET_SCK                                                  SPI_SCK                                                                                          // set by library:WIZNET
#define MBED_CONF_WIZNET_SOCKET_BUFSIZE                                       8192                                                                                             // set by library:WIZNET
